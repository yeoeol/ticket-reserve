...
public class PaymentConfirmedEventConsumer {
    ...
    public void listen(String message) {
        log.info("[Reservation-service : PaymentConfirmedEventConsumer.listen] 결제 완료 이벤트 수신: message = {}", message);
        try {
            ...
            log.info("[Reservation-service : PaymentConfirmedEventConsumer.listen] 예약 확정 처리 완료 - reservationId = {}", payload.getReservationId());
