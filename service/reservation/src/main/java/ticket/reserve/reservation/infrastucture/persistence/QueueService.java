...
public class QueueService {
    ...
    public QueueStatusResponseDto registerWaitingQueue(Long eventId, String userId) {
        ...
        queueRedisRepository.addToWaitingQueue(eventId, userId, currentTimeMills);
    ...
    public void processQueue() {
        ...
        for (Long eventId : eventIds) {
            ...
            queueRedisRepository.removeActiveBeforeExpiryTime(eventId, currentTimeMillis);

            // 대기열에서 선착순 ALLOW_COUNT 수만큼 조회
            Set<String> usersToEnter = queueRedisRepository.getOldestWaitingUsers(eventId, ALLOW_COUNT);
